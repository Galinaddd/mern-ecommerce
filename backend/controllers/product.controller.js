...
import { redis_client } from "../lib/redis.js";
...
export const getAllProducts = async (req, res) => {
  try {
    ...
    console.log("Error in getAllProductsController");
...
export const getFeaturedProducts = async (req, res) => {
  try {
    let featuredProducts = await redis_client.get("featured_products");
    if (featuredProducts) {
    ...
    //   store in redis for future quick assess
